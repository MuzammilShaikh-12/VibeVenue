...
nextArrow: <NextArrow /> ,
  ...
  return (
    <>
        <div className='lg:hidden mx-4 md:mx-12'>
            <HeroSlider {...settings}>
                    {
                        images.map((images)=>(
                            <div className='w-full h-56 md:h-80 py-3 px-2'>
                                <img src={`https://image.tmdb.org/t/p/original${images.backdrop_path}`} alt="hero banner" className='w-full h-full rounded-md object-cover shadow-md hover:shadow-xl transition-shadow duration-300' />
                            </div>
                        ))
                    }
            </HeroSlider>
        </div>
        <div className='hidden lg:block mx-10 xl:mx-20'>
